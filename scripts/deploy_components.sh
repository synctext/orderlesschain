...
ansible-playbook "${PROJECT_ABSOLUTE_PATH}"/deployment/ansible/playbooks/deploy_orderer.yml
ansible-playbook "${PROJECT_ABSOLUTE_PATH}"/deployment/ansible/playbooks/deploy_node.yml
ansible-playbook "${PROJECT_ABSOLUTE_PATH}"/deployment/ansible/playbooks/deploy_client.yml
