...
func MakeNewTransactionResultFabricAndFabricCRDT(counter, endorsementPolicy int, signer *signer.Signer) *TransactionResult {
	return &TransactionResult{
		transaction:                       transaction.NewClientTransaction(signer),
		transactionCounter:                counter,
		latencyMeasurement:                latencymeasurment.Latency,
...
func NewExecutor() *Executor {
	...
	if config.Config.IsOrderlessChain {
		...
		go tempEx.subscriberForTransactionEventsFabricAndFabricCRDT()
	} else {
